        ...
        lists: [
          {
            ...
            items: [
              ...
              {
                label: "BA (Hons) Buisness & Management",
      ...
      {navItems.map((item) => {
        ...
        return (
          ...
          >
            <Link
              href={item.href}
              className="relative inline-flex items-center gap-2 whitespace-nowrap text-white hover:text-white text-[13px] xl:text-[15px] 2xl:text-base font-semibold uppercase tracking-wide leading-none"
            >
              <span className="whitespace-nowrap">{item.label}</span>
              <span className="text-white leading-none -translate-y-[1px]">+</span>
...
{showFloatingApply && (
  <Link
    ...
    className="
      ...
      bg-[#940148] text-white
      w-[44px] min-h-[100px]
      px-3 py-3
      rounded-l-[12px]
      shadow-[0_10px_30px_rgba(0,0,0,0.22)]
      font-semibold uppercase tracking-[0.12em] text-[12px]
